...
class Recognition:
    def __init__(self,path):
        ...
        self.my_model = load_model('C:/Users/alienware/Desktop/mnisttest/model.h5')
...
if __name__ == '__main__':
    re = Recognition('C:/Users/alienware/Desktop/mnisttest/model.h5')
    rimg = Image.open('Num.png')
